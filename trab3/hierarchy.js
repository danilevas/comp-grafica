...
function handleKeyPress(event) {
    ...
    switch (ch) {
        ...
        case "T":
            ...
            torsoMatrix.setTranslate(0, 0, 0).rotate(torsoAngle, 0, 1, 0);
            legsAngle += 15;
            rightLegMatrix.setTranslate(2.5, -10, 0).rotate(legsAngle, 0, 1, 0);
            leftLegMatrix.setTranslate(-2.5, -10, 0).rotate(legsAngle, 0, 1, 0);
            break;
        case "s":
        case "S":
            shoulderAngle += 15;
...
var meu_canvas = document.getElementById("theCanvas");
var meu_rotator = new SimpleRotator(meu_canvas, animate);
